                            ...
                            <div className="row radio-row col-12">
                                ...
                                <div className="radio-btn1">
                                    <div className="col-md-4 dcl-right">
                                        <div className="conf-dcl"><Button variant="contained" onClick={() => setStep(5)}  color="primary">Previous</Button></div>
                                    </div>
                                    <div className="col-md-4 dcl-right">
                                        <div className="conf-dcl"><Button variant="contained" onClick={() => setStep(7)}  color="primary">Next</Button></div>
                                    </div>
